...
def solve_ravine():
    ...
    wait_for_cash(505)
    alch1.upgrade(CONST_UPG_TOP)
    alch1.upgrade(CONST_UPG_TOP)
    wait_for_cash(1060)
    alch1.upgrade(CONST_UPG_TOP)
    wait_for_cash(615)
    alch1.upgrade(CONST_UPG_MID)
    alch1.upgrade(CONST_UPG_MID)
    wait_for_cash(1100)
    ace1.upgrade(CONST_UPG_TOP)
    ace1.upgrade(CONST_UPG_TOP)
    wait_for_cash(2550)
    alch1.upgrade(CONST_UPG_TOP)
    wait_for_cash(1600)
    sniper1 = Monkey("sniper", 123, 887)
    sniper1.upgrade(CONST_UPG_MID)
    sniper1.upgrade(CONST_UPG_MID)
...
def solve_flooded_valley():
    ...
    wait_for_cash(535)
    sub2.upgrade(CONST_UPG_TOP)
    sub2.upgrade(CONST_UPG_TOP)
    wait_for_cash(1230)
    sub2.upgrade(CONST_UPG_BOT)
    sub2.upgrade(CONST_UPG_BOT)
    wait_for_cash(3485)
    sub2.upgrade(CONST_UPG_BOT)
    sub2.upgrade(CONST_UPG_BOT)
...
def solve_infernal():
    ...
    Monkey("hero", 122, 643)
    wait_for_cash(75)
    dart1.upgrade(CONST_UPG_BOT)
    wait_for_cash(170)
    sub1 = Monkey("sub", 487, 789)
    wait_for_cash(535)
    sub1.upgrade(CONST_UPG_TOP)
    sub1.upgrade(CONST_UPG_TOP)
    wait_for_cash(170)
    dart1.upgrade(CONST_UPG_BOT)
    wait_for_cash(1230)
...
def solve_bloody_puddles():
    ...
    dart1.upgrade(CONST_UPG_BOT)
    dart1.upgrade(CONST_UPG_BOT)
    dart2.upgrade(CONST_UPG_BOT)
    dart2.upgrade(CONST_UPG_BOT)
    dart3.upgrade(CONST_UPG_BOT)
    dart3.upgrade(CONST_UPG_BOT)
    wait_for_cash(415)
    dart4 = Monkey("dart", 357, 806)
    dart4.upgrade(CONST_UPG_BOT)
    dart4.upgrade(CONST_UPG_BOT)
    wait_for_cash(935)
    sub1.upgrade(CONST_UPG_BOT)
    wait_for_cash(2550)
...
def solve_workshop():
    ...
    wait_for_cash(680)
    spac2.upgrade(CONST_UPG_TOP)
    wait_for_cash(465)
    spac2.upgrade(CONST_UPG_BOT)
    spac2.upgrade(CONST_UPG_BOT)
    wait_for_cash(1190)
    spac2.upgrade(CONST_UPG_BOT)
    wait_for_cash(2975)
